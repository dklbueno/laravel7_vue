...
@section('content')
  ...
  <modal nome="adicionar" titulo="Adicionar">
    <formulario id="formAdicionar" css="" action="{{route('artigos.store')}}" method="post" enctype="" token="{{ csrf_token() }}">
      ...
      <div class="form-group">
        ...
        <input name="data" type="date" class="form-control" id="data" value="{{old('data')}}">
      </div>          
    </formulario>
    <span slot="botoes">
  ...
  <modal nome="editar" titulo="Editar">
    <formulario id="formEditar" css="" :action="'/admin/artigos/' + $store.state.item.id" method="put" enctype="" token="{{ csrf_token() }}">
      ...
      <div class="form-group">
        <label for="data">Data</label>
        <input name="data" type="date" class="form-control" id="data" value="" v-model="$store.state.item.data">
      </div>          
    </formulario>
    <span slot="botoes">
